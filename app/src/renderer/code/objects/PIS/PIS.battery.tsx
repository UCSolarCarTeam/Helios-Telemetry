  ...
  return {
    BMSRelayStatusFlags: [
      ...
      },
      {
        ...
        data: [{ value: currentPacket?.Battery.BMSRelayStatusFlags.DischargeRelayEnabled }]
      },
      {
        Name: 'Charge Relay Enabled',
        data: [{ value: currentPacket?.Battery.BMSRelayStatusFlags.ChargeRelayEnabled }]
      },
      {
        Name: 'Charger Safety Enabled',
        data: [{ value: currentPacket?.Battery.BMSRelayStatusFlags.ChargerSafetyEnabled }]
      },
      {
        Name: 'Multipurpose Input Signal',
        data: [{ value: currentPacket?.Battery.BMSRelayStatusFlags.MultiPurposeInputSignalStatus }]
      },
      {
        Name: 'Is Ready',
        data: [{ value: currentPacket?.Battery.BMSRelayStatusFlags.IsReadySignalStatus }]
      },
      {
        Name: 'Is Charging',
        data: [{ value: currentPacket?.Battery.BMSRelayStatusFlags.IsChargingSignalStatus }]
      },
      {
        Name: 'Malfunction Indicator Active',
        data: [{ value: currentPacket?.Battery.BMSRelayStatusFlags.MalfunctionIndicatorActive }]
      },
      {
        Name: 'Always On',
        data: [{ value: currentPacket?.Battery.BMSRelayStatusFlags.AlwaysOnSignalStatus }]
      }
    ] as I_PISField[],
    ...
    Fan: [
      {
        Name: 'Fan Voltage',
        data: [{ value: currentPacket?.Battery.FanVoltage, unit: 'V', min: 0, max: 100 }]
      },
      {
        Name: 'Fan Speed',
      ...
      },
      {
        ...
        data: [{ value: currentPacket?.Battery.RequestedFanSpeed, unit: 'V', min: 0, max: 100 }]
      }
    ] as I_PISField[],
    ...
    Temperature: [
      ...
      },
      {
        ...
        data: [{ value: currentPacket?.Battery.InternalTemperature, unit: '°C', min: 0, max: 100 }]
      }
    ] as I_PISField[],
    ...
    Cell: [
      {
        ...
        FString: '%s (%s) - %s (%s)',
        data: [
          { value: currentPacket?.Battery.LowCellVoltage, unit: 'V', min: 0, max: 100 },
          { value: currentPacket?.Battery.LowCellVoltageId },
          { value: currentPacket?.Battery.HighCellVoltage, unit: 'V', min: 0, max: 100 },
          { value: currentPacket?.Battery.HighCellVoltageId }
        ]
      },
      {
        Name: 'Battery Average Voltage',
        data: [{ value: currentPacket?.Battery.AverageCellVoltage, unit: 'V', min: 0, max: 100 }]
      },
      {
        Name: 'Battery Populated Cells',
        data: [{ value: currentPacket?.Battery.PopulatedCells, min: 0, max: 100 }]
      }
    ] as I_PISField[],
    ...
    Pack: [
      {
        Name: 'Pack Current',
        data: [{ value: currentPacket?.Battery.PackCurrent, unit: 'A', min: 0, max: 100 }]
      },
      {
        Name: 'Pack Voltage',
        data: [{ value: currentPacket?.Battery.PackVoltage, unit: 'V', min: 0, max: 100 }]
      },
      {
        Name: 'Pack Amphours',
        data: [{ value: currentPacket?.Battery.PackAmphours, unit: 'Ah', min: 0, max: 100 }]
      },
      {
        Name: 'Pack State of Charge',
        data: [{ value: currentPacket?.Battery.PackStateOfCharge, unit: '%', min: 0, max: 100 }]
      },
      {
        Name: 'Pack Depth of Discharge',
        data: [{ value: currentPacket?.Battery.PackDepthOfDischarge, unit: '%', min: 0, max: 100 }]
      },
      {
        Name: '12V Input Voltage',
        data: [{ value: currentPacket?.Battery['12vInputVoltage'], unit: 'V', min: 0, max: 100 }]
      }
    ] as I_PISField[],
    ...
    AuxBMS: [
      ...
      },
      {
        ...
        data: [{ value: currentPacket?.AuxBms.DischargeOpenButShouldBeClosed }]
      },
      {
        Name: 'Aux Voltage',
        data: [{ value: currentPacket?.AuxBms.AuxVoltage, unit: 'V', min: 0, max: 100 }]
      },
      {
      ...
      },
      {
        ...
        data: [{ value: currentPacket?.AuxBms.ChargeTripDueToHighCellVoltage }]
      },
      {
        Name: 'Charge Trip Due To High Temperature And Current',
        data: [{ value: currentPacket?.AuxBms.ChargeTripDueToHighTemperatureAndCurrent }]
      },
      {
      ...
      },
      {
        ...
        data: [{ value: currentPacket?.AuxBms.DischargeTripDueToHighTemperatureAndCurrent }]
      },
      {
        Name: 'Discharge Trip Due To Low Cell Voltage',
        data: [{ value: currentPacket?.AuxBms.DischargeTripDueToLowCellVoltage }]
      },
      {
      ...
      },
      {
        ...
        data: [{ value: currentPacket?.AuxBms.ChargeNotClosedDueToHighCurrent }]
      },
      {
        Name: 'Discharge Not Closed Due To High Current',
        data: [{ value: currentPacket?.AuxBms.DischargeNotClosedDueToHighCurrent }]
      }
    ] as I_PISField[]
  }
}
