...
export interface EndOfDayPredictorsProps {
...
const EndOfDayPredictorsComponent: React.FC<PerformanceRectanglesProps> = ({
  eodPredictor1,
  eodPredictor2,
  ep2Left,
  ep2Right,
  ...
  <Card className="h-32 pt-2">
    <p>End of Day Predictors</p>
        ...
        <div>
          ...
          <div>
            <div className="flex w-[5rem] items-center justify-between">
              ...
              <div className="mx-1 h-[0.1rem] flex-1 bg-darker-gray"></div>
