...
export const fakeData: ITelemetryData[] = [
  {
    ...
    Telemetry: {
      ...
      GpsDay: faker.number.int({ max: 100, min: 0 }),
      GpsFixStatusFlags: faker.number.int({ max: 100, min: 0 }),
      GpsHour: faker.number.int({ max: 100, min: 0 }),
      GpsLatitude: faker.number.int({ max: 90, min: 0 }),
      GpsLongitude: faker.number.int({ max: 90, min: 0 }),
      GpsMinute: faker.number.int({ max: 100, min: 0 }),
      GpsMonth: faker.number.int({ max: 100, min: 0 }),
      GpsSecond: faker.number.int({ max: 100, min: 0 }),
      GpsValidityFlags: faker.number.int({ max: 100, min: 0 }),
      GpsYear: faker.number.int({ max: 100, min: 0 }),
      MpuAccelerationX: faker.number.int({ max: 100, min: 0 }),
      MpuAccelerationY: faker.number.int({ max: 100, min: 0 }),
      MpuAccelerationZ: faker.number.int({ max: 100, min: 0 }),
      MpuRotationX: faker.number.int({ max: 100, min: 0 }),
      MpuRotationY: faker.number.int({ max: 100, min: 0 }),
      MpuRotationZ: faker.number.int({ max: 100, min: 0 }),
      MpuTemperature: faker.number.int({ max: 100, min: 0 }),
    },
    TimeStamp: 1,
    Title: "Helios",
  },
  ...
  },
  {
    ...
    Telemetry: {
      ...
      GpsFixStatusFlags: faker.number.int({ max: 100, min: 0 }),
      GpsHour: faker.number.int({ max: 100, min: 0 }),
      GpsLatitude: faker.number.int({ max: 100, min: 0 }),
      GpsLongitude: faker.number.int({ max: 100, min: 0 }),
      GpsMinute: faker.number.int({ max: 100, min: 0 }),
      GpsMonth: faker.number.int({ max: 100, min: 0 }),
      GpsSecond: faker.number.int({ max: 100, min: 0 }),
      GpsValidityFlags: faker.number.int({ max: 100, min: 0 }),
