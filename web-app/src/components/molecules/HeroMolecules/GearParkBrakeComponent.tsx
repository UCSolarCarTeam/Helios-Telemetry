...
function GearParkBrakeComponent (props: any) {
  ...
  return (
      ...
      <div className = "flex items-center flex-col">
        ...
        <div><h1 className = {g.valueOf() == gear.park ? "text-red-700" : "text-gray-700"}>P</h1></div>
        <div><h1 className = {g.valueOf() == gear.reverse ? "text-red-700" : "text-gray-700"}>R</h1></div>
        <div><h1 className = {g.valueOf() == gear.neutral ? "text-red-700" : "text-gray-700"}>N</h1></div>
        <div><h1 className = {g.valueOf() == gear.drive ? "text-red-700" : "text-gray-700"}>D</h1></div>
        </div>
